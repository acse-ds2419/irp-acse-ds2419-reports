% Imperial College ACSE 2019/20 IRP Project Plan
\documentclass[%
...
\title{Project Plan} 
\author{%
   \small Dominic Schwarz \\
   \small dominic.schwarz19@imperial.ac.uk \\
   \small \url{github.com/acse-ds2419}
}
\subject{Inference of Impactor Properties by Inversion of \\
...
\publishers{%\vspace{3em}
   \small Imperial College London \\
   \small Royal School of Mines \\
   \small Departement of Earth Science and Engineering \\
   \vspace{2em}
      \small Supervisor: \\
      \small Prof. Gareth Collins \\
      \small g.collins@imperial.ac.uk \\
   \vspace{2em}
   \small Project repository: \\
   \small \url{https://github.com/acse-2019/irp-acse-ds2419} \\
   \vspace{2em}
   \small Submitted as part of the MSc course in \\
   \small Applied Computational Science and Engineering. \\
   \vspace{2em}
   \small Total word count: 1448; 605~(sec.~1) + 633~(sec.~2) + 210~(sec.~3)
}
%\dedication{Widmung}
